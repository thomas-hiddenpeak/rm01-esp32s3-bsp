...
static int cmd_help(int argc, char **argv)
{
    ...
    printf("  eth_dhcp status      - 显示DHCP服务器详细状态\n");
    printf("  eth_dhcp enable      - 启动DHCP服务器\n");
    printf("  eth_dhcp disable     - 停止DHCP服务器\n");
    printf("  eth_dhcp reload      - 从NVS重新载入配置\n");
    printf("  eth_dhcp list        - 显示当前活跃的DHCP客户端列表\n");
    printf("  eth_dhcp reservations - 显示所有IP-MAC地址绑定预留\n");
    printf("\nDHCP IP-MAC绑定管理:\n");
    printf("  eth_dhcp reserve <mac> <ip> [desc] - 添加IP-MAC地址绑定\n");
    printf("    示例: eth_dhcp reserve aa:bb:cc:dd:ee:ff 10.10.99.100 \"主控设备\"\n");
    printf("  eth_dhcp unreserve <mac>   - 删除指定MAC地址的IP预留\n");
    printf("  eth_dhcp clear reservations - 清除所有IP-MAC地址绑定\n");
    printf("  eth_dhcp pool <start> <end> [hours] - 配置DHCP地址池\n");
    printf("    示例: eth_dhcp pool 10.10.99.100 10.10.99.105 12\n");
    printf("  eth_dhcp release <mac>     - 释放指定MAC地址的DHCP租约\n");
    printf("\n网关服务控制:\n");
    printf("  eth_gateway          - 显示网关服务状态\n");
    printf("  eth_gateway enable   - 启动网关服务\n");
    printf("  eth_gateway disable  - 停止网关服务\n");
    printf("\nTF卡存储控制 (13个命令):\n");
    printf("  📁 基本管理:\n");
